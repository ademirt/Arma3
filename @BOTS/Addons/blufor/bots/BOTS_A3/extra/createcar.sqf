...
sleep 3;
_unitAi playMove "Acts_listeningToRadio_In";

_unitAi groupChat "Attention base, delivery request!";

_unitAi playMove "Acts_listeningToRadio_Loop";

_unitAi groupChat "We need a Hunter HMG now!!";

_unitAi playMove "Acts_listeningToRadio_Out";
  ...
  private _unit = [_origin, 280, "B_Heli_Transport_03_unarmed_F", side player] call BIS_fnc_spawnVehicle;
