...
fnc_BE_initialize = {
	...
	BE_class_MBT = vehTank;
	BE_class_APC = vehAPC + vehIFV;
	BE_class_MRAP = vehLead + standardMRAP + [opMRAPu];
...
fnc_BE_broadcast = {
	params ["_type", "_reqs", "_data", "_bool", "_str"];
	...
	if (_type == "progress") then {
...

		{
			...
			_pI pushBack (parseText format ["Requirement: %1 -- Status: %2", _str, _bool]);
		} forEach _reqs;
	};

	if (_type == "restrictions") then {
		_pI pushBackUnique (parseText format ["Current FIA skill cap: %1", BE_current_FIA_Skill_Cap]);
		_pI pushBackUnique (parseText format ["Current FIA outfit percentage: %1", BE_current_FIA_Outfit]);
		_pI pushBackUnique (parseText format ["Current FIA garage size: %1", BE_current_FIA_GarageCap]);
		_pI pushBackUnique (parseText format ["Current personal garage size: %1", BE_current_Pers_GarageCap]);
		_pI pushBackUnique (parseText format ["Currently restricted vehicles: %1", BE_current_Vehicle_Restriction]);
		_pI pushBackUnique (parseText format ["Current FIA manpower cap: %1", BE_current_FIA_HR_Cap]);
		_pI pushBackUnique (parseText format ["Current FIA camp cap: %1", BE_current_FIA_Camp_Cap]);
		_pI pushBackUnique (parseText format ["Current FIA roadblock cap: %1", BE_current_FIA_RB_Cap]);
		_pI pushBackUnique (parseText format ["Current FIA watchpost cap: %1", BE_current_FIA_WP_Cap]);
		_pI pushBackUnique (parseText format ["Current FIA roadblock type: %1", ["simple", "advanced"] select (BE_current_FIA_RB_Style > 0)]);
		_pI pushBackUnique (parseText format ["Current FIA watchpost type: %1", ["simple", "advanced"] select (BE_current_FIA_WP_Style > 0)]);
	};

	[petros,"BE",_pI] remoteExec ["commsMP",stavros];
};

#define BE_STR_CTER1 "Own at least 1 Outpost or 1 Base or 1 Airport"
#define BE_STR_CTER2 "Own at least 1 Base or 1 Airport"
#define BE_STR_CTER3 "Own at least 1 Airport"
fnc_BE_C_TER = {
...
#define BE_STR_CWPN1 "Unlocked at least 2 primary weapons"
#define BE_STR_CWPN2 "Unlocked at least 4 primary weapons"
#define BE_STR_CWPN3 "Unlocked at least 6 primary weapons"
fnc_BE_C_WPN = {
...
#define BE_STR_CHEL1 ""
#define BE_STR_CHEL2 "Unlocked at least 1 helmet"
#define BE_STR_CHEL3 "Unlocked at least 1 helmet"
fnc_BE_C_HEL = {
...
#define BE_STR_CVES1 "Unlocked at least 1 vest"
#define BE_STR_CVES2 "Unlocked at least 1 vest"
#define BE_STR_CVES3 "Unlocked at least 1 vest"
fnc_BE_C_VES = {
...
#define BE_STR_COPT1 "Unlocked at least 1 Optic"
#define BE_STR_COPT2 ""
#define BE_STR_COPT3 ""
fnc_BE_C_OPT = {
...
#define BE_STR_CNVG1 ""
#define BE_STR_CNVG2 ""
#define BE_STR_CNVG3 "Unlocked NVGs"
fnc_BE_C_NVG = {
	BE_STR_CNVG = BE_STR_CNVG3;
	[(indNVG in unlockedItems), BE_STR_CNVG]
};

#define BE_STR_CAT1 "Unlocked at least 1 type AT"
#define BE_STR_CAT2 "Unlocked at least 1 type AT"
#define BE_STR_CAT3 "Unlocked at least 1 type AT"
fnc_BE_C_AT = {
...
#define BE_STR_CAA1 ""
#define BE_STR_CAA2 "Unlocked at least 1 type AA"
#define BE_STR_CAA3 "Unlocked at least 1 type AA"
fnc_BE_C_AA = {
...
#define BE_STR_CATM1 ""
#define BE_STR_CATM2 ""
#define BE_STR_CATM3 "Unlocked AT Mines"
fnc_BE_C_ATM = {
