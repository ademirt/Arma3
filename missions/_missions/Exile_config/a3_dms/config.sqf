...
/* Mission System Settings */
	...
	DMS_MinServerFPS					= 8; 						// Minimum server FPS for missions to start
...
/* DonkeyPunchDMS Custom Roadkill Settings for Survivor AI*/
	...
	DMS_banditSide						= WEST;						// The side (team) that AI Bandits will spawn on
/* DonkeyPunchDMS Custom Side Factions */
	DMS_heroSide						= WEST;						// The side (team) that AI Heros will spawn on
	DMS_survivorSide					= CIVILIAN;						// The side (team) that AI Survivor will spawn on
	...
	DMS_ai_skill_randomIntermediate		= ["moderate","moderate","easy","easy","easy"];//["difficult","difficult","moderate","moderate","moderate"];	// 60% chance for "moderate", 40% chance for "difficult" AI.
	...
	DMS_AI_AimCoef_difficult			= 0.60;						// "Custom Aim Coefficient" (weapon sway multiplier) for "difficult" AI
	DMS_AI_AimCoef_hardcore				= 0.59;						// "Custom Aim Coefficient" (weapon sway multiplier) for "hardcore" AI
	...
	DMS_AI_destroyStaticWeapon_chance	= 85;						// Percent chance that a static weapon will be destroyed (only applied if "DMS_AI_destroyStaticWeapon" is true)
