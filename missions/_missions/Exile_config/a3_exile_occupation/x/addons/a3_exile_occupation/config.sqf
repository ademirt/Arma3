...
SC_randomSpawnChance			= 45;						// Percentage chance of spawning if suitable player found
...
SC_randomSpawnFrequency			= 3999;						// time in seconds between the possibility of random AI hunting the same player (1800 for 30 minutes)
...
SC_numberofHeliCrashes      	= 0;                    // if SC_occupyHeliCrashes = true spawn this many loot crates
