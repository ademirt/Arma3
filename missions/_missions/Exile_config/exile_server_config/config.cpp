...
class CfgSettings
{
	...
	class ServerSettings
	{
		...
		*/
		...
		devs[] = 
		{
			{"3333333333333222","[EXILE|DEV] Eichi"},
			{"454545454545454454454","[EXILE|DEV] Grim"},
			{"45454545454545454","[EXILE|DEV] Vishpala"},
			{"4544545454545454545","[EXILE|DEV] Niuva"}
		};
	};
		...
		*/
		...
		class SupplyBox 
		{
			...
			*/
			...
			dropAltitude = 250; // altitude of the drop
