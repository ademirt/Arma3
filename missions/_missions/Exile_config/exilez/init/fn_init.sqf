...
CorpseDeleteDelay            = 180;              // delay before a zombie corpse is deleted.
Debug                        = false;             // debug messages.
MinSpawnDistance             = 80;               // Closest distance from any player to spawn a zombie.
MaxSpawnDistance             = 350;              // Max distance a zombie should spawn from a player.
...
_Ryanzombiesattackspeed 	           = 1.8;	 // Attack speed, *(Time is seconds between attacks)
_Ryanzombiesattackdistance 	           = 1.5;	     // Attack distance, *(in meters)
...
_Ryanzombiesdamagecar 		           = 0.000001;	 // Attack damage to car *(% of car health per hit, 1 is 100%)
_Ryanzombiesdamageair 		           = 0.000001;	 // Attack damage to air *(% of car health per hit, 1 is 100%)
_Ryanzombiesdamagetank                 = 0.0000001;	 // Attack damage to tank *(% of car health per hit, 1 is 100%)
_Ryanzombiesdamagecarstrenth           = 0.0000001;	 // Car attack strength *(Knockback strength in M/S)
_Ryanzombiesdamageairstrenth           = 0.0000001;	     // Air attack strength *(Knockback strength M/S)
_Ryanzombiesdamagetankstrenth          = 0.0000001;	 // Tank attack strength *(Knockback strength M/S)
...
_ryanzombieslimit                      = 12;    // Player detection distance in meters
...
_ryanzombiesinfectedchance             = 0.8;     //Precent chances to be infected on hit
...
_ryanzombiesantivirusduration          = 350;    //Antivirus duration *(5 minutes)
...
/* 1 Frequency */            185,                // time in seconds between each new zombie.
...
/* 1 Min Frequency */        40,                 // min time in minutes between each new zombie horde.
/* 2 Max Frequency */        195,                 // max time in minutes between each new zombie horde.
/* 3 Vest group */           Nothing,              // Vest function defined in ZVest.sqf
/* 4 Loot group */           Nothing,         // Loot function defined in ZLoot.sqf
...
/* 1  Trigger Positions */   chernarus,             // The name of the array used to list all trigger position in the TriggerPositions.sqf file
/* 2  Max Zombies */         12,                 // The maximum number of zombies for that trigger.
/* 3  Activation Delay */    6,                 // The delay before the activation of the trigger.
/* 4  Spawn Delay */         15,                 // The delay between each zombie spawn right after the activation until the Max group size is reached.
/* 5  Respawn Delay */       220,                 // The respawn delay after the max group size was reached
...
/* 11 Vest group */          Nothing,              // The name of the Array used to list all the possible vest for that trigger. ZVest.sqf
/* 12 Loot group */          Nothing,             // The name of the Array used to list all the possible loot for that trigger. ZLoot.sqf
