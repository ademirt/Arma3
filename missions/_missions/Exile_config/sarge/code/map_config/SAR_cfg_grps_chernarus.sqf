...
if (SAR_dynamic_spawning) then {
    ...
    [["max_grps","rnd_grps","max_p_grp"],[[1,0,3],[75,0,75],[4,0,4]],"SAR_area_2_0"] call SAR_AI_mon_upd; 
    ...
    [["max_grps","rnd_grps","max_p_grp"],[[1,0,3],[50,0,50],[4,0,4]],"SAR_area_4_0"] call SAR_AI_mon_upd; 
    ...
    [["max_grps","rnd_grps","max_p_grp"],[[0,0,3],[50,0,50],[3,0,3]],"SAR_area_2_2"] call SAR_AI_mon_upd; 
    ...
    [["max_grps","rnd_grps","max_p_grp"],[[1,0,0],[75,0,0],[3,0,0]],"SAR_area_2_4"] call SAR_AI_mon_upd; 
    ...
    [["max_grps","rnd_grps","max_p_grp"],[[1,0,0],[75,0,0],[3,0,0]],"SAR_area_3_5"] call SAR_AI_mon_upd; 
...
//---------------------------------------------------------------------------------
//
//      format: [areamarker,type_of_group,(respawn),(respawntime)] call SAR_fnc_AI_heli;
//
...
//---------------------------------------------------------------------------------
// 
//      format: [areamarker,type_of_group,number_of_snipers,number_of_riflemen,action_to_do,(respawn),(respawntime)] call SAR_fnc_AI_heli;
//
//      areamarker          : Name of an area, as defined in your area definitions (MUST NOT BE similar to SAR_area_ ! THIS IS IMPORTANT!)
//      type_of_group       : 1 = military, 2 = survivors, 3 = bandits
...
[SAR_marker_DEBUG_devilscastle,1,0,6,"fortify",true] call SAR_fnc_AI_heli;

// example war scenario in the northwest. Comment OUT after having had a look at it!
[SAR_marker_DEBUG_veh,1,0,9,"patrol",true] call SAR_fnc_AI_heli;
[SAR_marker_DEBUG_veh,2,0,9,"patrol",true] call SAR_fnc_AI_heli;
[SAR_marker_DEBUG_veh,3,0,9,"patrol",true] call SAR_fnc_AI_heli;
[SAR_marker_DEBUG_veh,3,0,9,"patrol",true] call SAR_fnc_AI_heli;
