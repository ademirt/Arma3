...
private _veiculo = ["I_G_Offroad_01_armed_F","I_C_Offroad_02_LMG_F"] call BIS_fnc_selectRandom;

private _side = side _unitAi;
...
_unitAi groupChat "We need a Hunter HMG now!!";
  ...
  sleep (random 6);
  [_side, "HQ"] sideChat "Request Hunter HMG confirmed.";
  sleep 1;
  [_side, "HQ"] sideChat "Dispatching heavy airborne resupply to marked position.";
  [_side, "HQ"] sideChat _chatter;
  ...
  private _unit = [_origin, 300, "I_Heli_Transport_02_F", side player] call BIS_fnc_spawnVehicle;
  ...
  waitUntil {_unitActual distance _posAI > 2000};
