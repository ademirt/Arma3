...
cleantime = 500;//time to delete dead bodies, vehicles etc..
...
if !(hayIFA) then
	...
	"VSM_Shemagh_Facemask_tan_Glasses"]	+ uniformsSDK + civUniforms;//Initial Arsenal available items
...
if (!activeGREF) then
    ...
    if !(hayIFA) then
    	{
	    unlockedWeapons = ["hgun_PDW2000_F","hgun_Pistol_01_F","hgun_ACPC2_F","Binocular","arifle_AKM_F","arifle_AKS_F","SMG_05_F","SMG_02_F"]
		+
		["hlc_rifle_ak12","hlc_rifle_G36MLIC","hlc_rifle_falosw","hlc_pistol_P226R_40Combat","hlc_rifle_ak74m_MTK"];
		
		unlockedRifles = ["hgun_PDW2000_F","arifle_AKM_F","arifle_AKS_F","SMG_05_F","SMG_02_F"]
		 +
		["hlc_rifle_ak12","hlc_rifle_G36MLIC","hlc_rifle_falosw","hlc_pistol_P226R_40Combat","hlc_rifle_ak74m_MTK"];
		
		unlockedMagazines = ["9Rnd_45ACP_Mag","30Rnd_9x21_Mag","30Rnd_762x39_Mag_F","MiniGrenade","1Rnd_HE_Grenade_shell","30Rnd_545x39_Mag_F","30Rnd_9x21_Mag_SMG_02","10Rnd_9x21_Mag","200Rnd_556x45_Box_F","IEDLandBig_Remote_Mag","IEDUrbanBig_Remote_Mag","IEDLandSmall_Remote_Mag","IEDUrbanSmall_Remote_Mag","100Rnd_65x39_caseless_mag","30Rnd_65x39_caseless_mag"]
...
unlockedBackpacks = if !(hayIFA) then {["B_FieldPack_oli","B_FieldPack_blk","B_FieldPack_ocamo","B_FieldPack_oucamo","B_FieldPack_cbr","TAC_MTAP_BK2","TAC_MTAP_RG2"]} else {["B_LIB_US_M2Flamethrower","B_LIB_SOV_RA_MGAmmoBag_Empty"]}; //Initial Arsenal available backpacks
