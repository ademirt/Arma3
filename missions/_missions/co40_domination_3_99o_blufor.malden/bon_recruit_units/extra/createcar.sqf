...
private _veiculo = ["B_MRAP_01_gmg_F","B_MRAP_01_hmg_F"] call BIS_fnc_selectRandom;
...
_unitAi groupChat "We need a Hunter HMG now!!";
  ...
  private _unit = [_origin, 300, "B_Heli_Transport_03_F", side player] call BIS_fnc_spawnVehicle;
