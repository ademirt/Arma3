...
_pilot1 addEventHandler ["HandleDamage",{_damage = (_this select 2)*1.70; _damage}];//teste
__TRACE_1("","_pilot1")
_pilot1 call d_fnc_removenvgoggles_fak;

private _pilot2 = _owngroup createUnit [d_sm_pilottype, getPosATL _pilot1, [], 0, "FORM"];
_pilot2 addEventHandler ["HandleDamage",{_damage = (_this select 2)*1.70; _damage}];//teste
__TRACE_1("","_pilot2")
