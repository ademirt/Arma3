class CfgCommunicationMenu
{
	...
	class UAV2
	{
		...
		submenu = ""; // Submenu opened upon activation
		expression = "ghst_uavsupport2 = [(getmarkerpos ""ghst_player_support""),""USAF_RQ4A"",1000,PARAM_Cooldowns] spawn ghst_fnc_uavsupport;"; // Code executed upon activation (ignored when the submenu is not empty)
		icon = "";//"\a3\Ui_f\data\GUI\Cfg\CommunicationMenu\call_ca.paa"; // Icon displayed permanently next to the command menu
		cursor = "\a3\Ui_f\data\IGUI\Cfg\Cursors\iconCursorSupport_ca.paa"; // Custom cursor displayed when the item is selected
		enable = "1"; // Simple expression condition for enabling the item
	};
	...
	class UGV
	{
		...
		submenu = ""; // Submenu opened upon activation
		expression = "ghst_ugvsupport = [(getmarkerpos ""ghst_player_support""),""B_UGV_01_rcws_F"",2,PARAM_Cooldowns] spawn ghst_fnc_ugvsupport;"; // Code executed upon activation (ignored when the submenu is not empty)
