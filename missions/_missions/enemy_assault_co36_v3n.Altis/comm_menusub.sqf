...
["MQ-4A", [2], "", -5, [["expression", "ghst_uavsupport = [(getmarkerpos ""ghst_player_support""),""B_UAV_02_F"",500,PARAM_Cooldowns] spawn ghst_fnc_uavsupport;"]], "1", "1"],

["MQ-12 Falcon", [3], "", -5, [["expression", "ghst_ugvsupport = [(getmarkerpos ""ghst_player_support""),""B_T_UAV_03_F"",100,PARAM_Cooldowns] spawn ghst_fnc_uavsupport;"]], "1", "1"],

["UGV Stomper RCWS", [4], "", -5, [["expression", "ghst_ugvsupport = [(getmarkerpos ""ghst_player_support""),""B_UGV_01_rcws_F"",2,PARAM_Cooldowns] spawn ghst_fnc_ugvsupport;"]], "1", "1"],
