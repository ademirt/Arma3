...
if (_PARAM_RHS == 1) then {
	...
	ghst_friendlybase_def = ["RHS_M6","RHS_Stinger_AA_pod_D"];
	...
	case 0: {
		...
		ghst_attack_heli_list = ["RHS_Mi24V_FAB_vdv","RHS_Mi24P_vdv","RHS_Ka52_vvsc"];
...
//Default Game units with option mods
	...
	ghst_friendlybase_def = ["B_APC_Tracked_01_AA_F","B_static_AA_F"];
