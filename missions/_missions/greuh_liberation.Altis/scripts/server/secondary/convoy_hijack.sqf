...
{ _x createUnit [_spawnpos, _troops_group,"this addMPEventHandler [""MPKilled"", {_this spawn kill_manager}]; this addEventHandler [""HandleDamage"",{_damage = (_this select 2)*1.85; _damage}];", 0.5, "private"];//teste
