...
while { count units _grp < 3 } do {
	( militia_squad call BIS_fnc_selectRandom ) createUnit [ getpos _vehicle, _grp,'this addMPEventHandler [''MPKilled'', {_this spawn kill_manager}]; this addEventHandler ["HandleDamage",{_damage = (_this select 2)*1.85; _damage}]', 0.5, 'private'];
