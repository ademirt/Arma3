...
if ( count _allposts > 0 ) then {
...

	{
		...
		_unitclasspost createUnit [ _squadpos, _grp2, 'nextunit_post = this; this addMPEventHandler [''MPKilled'', {_this spawn kill_manager}]; this addEventHandler ["HandleDamage",{_damage = (_this select 2)*1.85; _damage}];', 0.5, 'private'];//teste
