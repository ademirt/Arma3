...
_vSpawnCrashes2 = {
		...
		_hstrt = [[1324.5992,797.98096,300],[12087.144,1397.6597,300],[14358.261,8360.5039,300]] call BIS_fnc_selectRandom;
		...
		_cwrk setPos _hstrt;
		_cwrk engineOn true;
		_cwrk flyInHeight 165;
		_cwrk forceSpeed 110;
		...
		_hplt setdamage 1;
		player moveindriver _cwrk;
		player assignAsDriver _cwrk;	
		
		_cwrk flyInHeight 97;
		_cwrk forceSpeed 160;
