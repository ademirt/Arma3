...
["d_temp_mark_arty_marker", _pos_lt, "ICON", d_color_m_marker, [1, 1], player call d_fnc_getplayername, 0, d_arty_m_marker] call d_fnc_CreateMarkerLocal;
...
if (d_ari_type != "") then {
	[player, _pos_lt, player call d_fnc_getplayername, d_ari_type, d_ari_salvos] remoteExecCall ["d_fnc_at_serv", 2];
