...
_arrow_over_head setPosASL [_pspsxx select 0, _pspsxx select 1, (_pspsxx select 2) + 2.2];
...
_camera camSetTarget [_pspsxx select 0, _pspsxx select 1 , (player modelToWorld [0,0,1.5]) select 2];
...
0 = [parseText format [ "<br/><t font='PuristaMedium' align='left' size='2.3'> Welcome to Domination! 3</t><br/>  <t align='left' size='1'>  Version 3.82  </t>"], [safeZoneX + 0.1,safeZoneY + safeZoneH - 0.2,0.9,0.3], nil, 5, 1, 0]  spawn BIS_fnc_textTiles;

_camera camSetTarget player;
_p_tpos = [_pspsxx select 0, _pspsxx select 1, (player modelToWorld [0,0,2]) select 2];
...
[
	[
		...
		[player call d_fnc_getplayername,"<t size='1.0' font='RobotoCondensed'>%1</t><br/>", 5],
