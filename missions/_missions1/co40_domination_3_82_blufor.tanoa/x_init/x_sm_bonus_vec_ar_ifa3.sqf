...
switch (d_own_side) do {
	...
	case "EAST": {["LIB_T34_76","LIB_SU85","LIB_JS2_43","LIB_M4A2_SOV","LIB_T34_85","LIB_P39","LIB_RA_P39_3","LIB_RA_P39_2","LIB_Pe2","LIB_M4A3_75","LIB_M4A3_75_Tubes","LIB_US_P39","LIB_US_P39_2","LIB_P47"]};
};
