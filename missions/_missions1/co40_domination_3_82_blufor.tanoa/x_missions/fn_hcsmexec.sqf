...
#endif
#ifdef __STRATIS__
execVM format ["x_missions\ma3s\%2%1.sqf", param [0], param [1]];
#endif
#ifdef __MALDEN__
execVM format ["x_missions\ma3m\%2%1.sqf", param [0], param [1]];
#endif
#ifdef __IFA3LITE__
execVM format ["x_missions\mifa3\%2%1.sqf", param [0], param [1]];
#endif
sleep 7.012;
