...
if (isNil "_name_dragee" || {_name_dragee == ""}) then {_name_dragee = _dragee call d_fnc_getplayername; _dragee setVariable ["d_phname", nil]};
...
xr_dragprone_keyDownEHId = (findDisplay 46) displayAddEventHandler ["KeyDown", {((param [1]) in xr_dragprone_key_ar)}];
sleep 0.5;
