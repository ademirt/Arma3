...
#ifdef __TT__
	case 48: {d_hq_logic_blufor1 kbTell [d_hq_logic_blufor2,"HQ_W","MHQDestroyed",["1","",param [1],[]],"SIDE"]};
	case 49: {d_hq_logic_opfor1 kbTell [d_hq_logic_opfor2,"HQ_E","MHQDestroyed",["1","",param [1],[]],"SIDE"]};
#endif
};