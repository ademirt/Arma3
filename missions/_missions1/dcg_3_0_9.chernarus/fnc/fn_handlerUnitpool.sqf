...
if (SEN_allowMod isEqualTo 1) then { // if modified content mission parameter is on
	...
	if (_return) then {
		...
		_eastPool = ["rhs_msv_junior_sergeant","rhs_msv_engineer","rhs_msv_medic","rhs_msv_LAT","rhs_msv_RShG2","rhs_msv_aa","rhs_msv_machinegunner","rhs_msv_grenadier","rhs_msv_efreitor","rhs_msv_marksman","LOP_US_Infantry_Corpsman","LOP_US_Infantry_MG","LOP_US_Infantry_Engineer","rhs_msv_strelok_rpg_assist","rhs_vdv_flora_at","rhs_vdv_flora_aa"];
		_indVehPool = ["RHS_BM21_chdkz","rhs_zsu234_chdkz","rhs_bmd2_chdkz","rhs_btr70_chdkz","rhs_t72bb_chdkz","rhs_uaz_open_chdkz","LOP_AFR_BTR60","LOP_AFR_T72BA","LOP_AFR_M113_W","LOP_AM_Landrover_M2","LOP_AFR_Landrover_M2","rhs_zsu234_aa"];
		_eastVehPool = ["rhs_tigr_vdv","rhs_bmp1_vdv","rhs_bmp2e_vdv","rhs_t72bd_tv","rhs_t90_tv","rhs_btr80_vmf","rhs_btr80a_msv","rhs_t80b","LOP_US_ZSU234","RHS_UAZ_MSV_01","LOP_ChDKZ_Ural","LOP_ChDKZ_Ural_open","rhs_t80um","rhs_t80uk","rhs_t80u45m","rhs_sprut_vdv"];
		_indAirPool = ["RHS_Mi24P_vvs","RHS_Ka52_vvsc"];
		_eastAirPool = ["RHS_Su25SM_KH29_vvsc","RHS_Ka52_vvsc","RHS_Ka52_vvs","RHS_Mi24P_vvs","RHS_Mi24P_AT_vdv","RHS_Mi24P_CAS_vdv","RHS_Mi24V_UPK23_vdv"];
		_indSniperPool = ["rhs_msv_marksman","rhs_mvd_izlom_marksman"];
		_eastSniperPool = ["rhs_msv_marksman","rhs_vdv_marksman","rhs_mvd_izlom_marksman"];
		_indOfficerPool = ["rhs_g_Soldier_SL_F","rhs_msv_officer"];
		_eastOfficerPool = ["rhs_msv_officer_armored","rhs_msv_officer"];
