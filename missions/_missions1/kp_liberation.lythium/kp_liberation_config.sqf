...
GRLIB_halo_altitude = 400;																						// Altitude in metres for the HALO jump.
...
KP_liberation_civinfo_chance = 65;																				// Civil Informant spawn chance. (0-100)
...
KP_liberation_convoy_ambush_chance = 80;																			// Chance that a logistic convoy will be ambushed, when civil reputation is low.
...
KP_liberation_resistance_ambush_chance = 60;																	// Chance that some guerilla units will spawn in blufor sectors for an ambush, if reputation is low.
