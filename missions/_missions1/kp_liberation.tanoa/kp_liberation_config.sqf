...
GRLIB_sector_size = 1800;																						// Range to activate a sector.
...
GRLIB_civilians_amount = 6 						* GRLIB_civilian_activity;									// Civilian count multiplier.
GRLIB_cleanup_delay = 1000;																						// Time in seconds until bodies of dead soldiers are cleaned up.
...
KP_liberation_civinfo_chance = 60;																				// Civil Informant spawn chance. (0-100)
