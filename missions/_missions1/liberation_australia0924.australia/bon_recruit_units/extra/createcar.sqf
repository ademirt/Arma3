...
//sleep (random 3);
//_auto = createVehicle ["B_MRAP_01_hmg_F", getpos _unit,[],0,""];
...
//_type = _this select 4;
  ...
  _unit = [_originActual, 180, "B_Heli_Transport_03_F", side player] call BIS_fnc_spawnVehicle;
  _unitActual = _unit select 0;
  _unitGroup = _unit select 2;
  _unitActual groupChat "Transport is feet dry. Out.";

  _unitActual flyInHeight 120;
