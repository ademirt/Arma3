...
_unitAi groupChat "We need a Hunter HMG now!!";
  ...
  private _origin = [_posAI, 1950, floor random 360] call BIS_fnc_relPos;
  ...
  waitUntil {_unitActual distance _posAI < 900};
