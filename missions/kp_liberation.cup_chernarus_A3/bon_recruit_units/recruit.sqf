...
if (_unittype == "B_helipilot_F") then {
	...
	private _ve_heli = _hlTrp call BIS_fnc_selectRandom;
	//create group and aircraft
	private _heli_TR = createVehicle [_ve_heli, [0,0,0], [], 550, "FLY"];
...
if (_unittype == "B_Captain_Jay_F") then {
	...
	private _hlclass = _hlX call BIS_fnc_selectRandom;
	
	//create group and aircraft
	private _heli_at = createVehicle [_hlclass, [0,0,0], [], 500, "FLY"];
...
if (_unittype == "B_G_engineer_F") then {
   ...
   _unit addAction ["<t color='#ff9900'>Request Vehicle</t>","bon_recruit_units\extra\createcar.sqf",[],1,false,true,""];
	...
	_unit forceAddUniform "Multicam_Arid_Black_casual_Camo";
	...
	_unit addItemToBackpack "150Rnd_556x45_Drum_Mag_Tracer_F";
	_unit addHeadgear "VSM_OGA_OD_OPS_2";
	_unit addGoggles "G_Bandanna_oli";

	[_unit,"GreekHead_A3_06","male06eng"] call BIS_fnc_setIdentity;
